...
python /home/roland/copernicus/copernicus.py > "/home/roland/copernicus/log/copernicus-"`date +"%Y-%m-%d-%H-%M-%S"`".log"

source activate gdal
python /home/roland/copernicus/copernicus_analysis.py > "/home/roland/copernicus/log/copernicus_analysis-"`date +"%Y-%m-%d-%H-%M-%S"`".log"